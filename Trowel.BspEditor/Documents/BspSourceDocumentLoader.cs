...
using Trowel.BspEditor.Environment.Controls;
using Trowel.BspEditor.Environment.Empty;
using Trowel.BspEditor.Primitives;
using Trowel.BspEditor.Providers;
using Trowel.BspEditor.Providers.Processors;
...
namespace Trowel.BspEditor.Documents
{
    /// <summary>
