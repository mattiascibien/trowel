...
using Trowel.BspEditor.Tools.Selection.TransformationHandles;
using Trowel.BspEditor.Tools.Widgets;
...
namespace Trowel.BspEditor.Tools.Selection
{
    ...
    public class SelectTool : BaseDraggableTool, ISettingsContainer
    {
        ...
        string ISettingsContainer.Name => "Trowel.BspEditor.Tools.SelectTool";
