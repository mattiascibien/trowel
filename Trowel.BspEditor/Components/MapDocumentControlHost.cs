using Trowel.BspEditor.Controls;
using Trowel.BspEditor.Controls.Layout;
...
namespace Trowel.BspEditor.Components
{
    ...
    public class MapDocumentControlHost : UserControl, ISettingsContainer, IUIShutdownHook, IUIStartupHook
    {
        ...
        string ISettingsContainer.Name => "Trowel.BspEditor.Components.MapDocumentControlHost";
