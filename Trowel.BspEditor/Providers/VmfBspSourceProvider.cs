...
using Plane = Trowel.DataStructures.Geometric.Precision.Plane;
using Polyhedron = Trowel.DataStructures.Geometric.Precision.Polyhedron;
using PVector3 = Trowel.DataStructures.Geometric.Precision.Vector3;
